...
__all__ = ['CocoDetection', 'CocoXDetection', 'CocoXDetectiontrain1']
...
class CocoXDetection(torchvision.datasets.VisionDataset):
    ...
    def _load_image_X(self, id: int) -> Image.Image:
        ...
        # path_1 = path_0.replace('images', 'imagesIR')
        # --------------------------------------------------------------------------------------wen
        path0 = os.path.join(self.root, path_0)
        path1 = path0.replace('images', 'imagesIR')
        # path0 = os.path.join(self.root, path_0)
        # path1 = path0
        image_0 = Image.open(path0).convert("RGB")
    ...
    def getitem_X(self, index: int) -> Tuple[Any, Any, Any]:
        ...
        #     image_0, image_1, target = self.transforms(image_0, image_1, target)
...
@register
class CocoXDetectiontrain1(CocoXDetection):
    # def _load_image_X(self, id: int) -> Image.Image:
        # path_0 = self.coco.loadImgs(id)[0]["file_name"]
